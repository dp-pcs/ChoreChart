(()=>{var e={};e.id=210,e.ids=[210],e.modules={3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},4291:(e,t,r)=>{"use strict";r.r(t),r.d(t,{patchFetch:()=>m,routeModule:()=>u,serverHooks:()=>p,workAsyncStorage:()=>h,workUnitAsyncStorage:()=>d});var s={};r.r(s),r.d(s,{POST:()=>l});var o=r(96559),a=r(48088),n=r(37719),i=r(32190),c=r(4722);async function l(e){try{let{schedule:t,startDate:r,format:s}=await e.json();if(!t)return i.NextResponse.json({error:"Schedule is required"},{status:400});let o=r?new Date(r):new Date;if("ics"===s||!s){let e=c.m.generateiOSCalendarFile(t,o);return new i.NextResponse(e,{status:200,headers:{"Content-Type":"text/calendar","Content-Disposition":`attachment; filename="chorbit-schedule-${t.id}.ics"`}})}if("shortcuts"===s)return i.NextResponse.json({schedule:t,startDate:o,appName:"ChoreChart",generatedBy:"Chorbit AI"});return i.NextResponse.json({error:"Unsupported export format"},{status:400})}catch(e){return console.error("Chorbit export error:",e),i.NextResponse.json({error:"Failed to export schedule"},{status:500})}}let u=new o.AppRouteRouteModule({definition:{kind:a.RouteKind.APP_ROUTE,page:"/api/chorbit/export/route",pathname:"/api/chorbit/export",filename:"route",bundlePath:"app/api/chorbit/export/route"},resolvedPagePath:"/codebuild/output/src3049652603/src/ChoreChart/web/src/app/api/chorbit/export/route.ts",nextConfigOutput:"",userland:s}),{workAsyncStorage:h,workUnitAsyncStorage:d,serverHooks:p}=u;function m(){return(0,n.patchFetch)({workAsyncStorage:h,workUnitAsyncStorage:d})}},4722:(e,t,r)=>{"use strict";r.d(t,{m:()=>n});let s=null;if(process.env.OPENAI_API_KEY)try{(s=r(67312)).default&&(s=s.default),s=new s({apiKey:process.env.OPENAI_API_KEY})}catch(e){console.log("OpenAI not available, using demo mode for Chorbit:",e)}let o=`You are Chorbit, a friendly and encouraging AI assistant designed specifically for kids and families managing chores and responsibilities.
...
Remember: You're here to help kids succeed with their responsibilities while building good habits and confidence!`;class a{async chat(e,t,r){let a={id:`user-${Date.now()}`,role:"user",content:e,timestamp:new Date,userId:t};this.conversationHistory.push(a);let n=o;r&&(n+=`
...
Make it encouraging and realistic for a kid to follow!`;try{if(!s)throw Error("OpenAI not configured");let e=await s.chat.completions.create({model:process.env.OPENAI_MODEL||"gpt-3.5-turbo",messages:[{role:"system",content:o},{role:"user",content:n}],max_tokens:500,temperature:.8}),t=e.choices[0]?.message?.content||"";try{return JSON.parse(t)}catch{return{id:`schedule-${Date.now()}`,title:"Your Chorbit-Generated Schedule",tasks:r.slice(0,3).map((e,t)=>({name:e.title,duration:e.estimatedMinutes||15,priority:0===t?"high":"medium",tips:`Take your time and do your best! Remember, $${e.reward} awaits! 🌟`})),totalTime:r.slice(0,3).reduce((e,t)=>e+(t.estimatedMinutes||15),0),aiRecommendations:["Start with the hardest task when you have the most energy!","Take a 5-minute break between chores to stay fresh.","Put on your favorite music to make it more fun! \uD83C\uDFB5"]}}}catch(e){throw console.error("Schedule generation error:",e),Error("Chorbit had trouble creating your schedule. Try again!")}}generateiOSCalendarFile(e,t){let r=["BEGIN:VCALENDAR","VERSION:2.0","PRODID:-//ChoreChart//Chorbit Schedule//EN","CALSCALE:GREGORIAN","METHOD:PUBLISH"];return e.tasks.forEach((s,o)=>{let a=new Date(t);a.setMinutes(a.getMinutes()+o*s.duration);let n=new Date(a);n.setMinutes(n.getMinutes()+s.duration),r.push("BEGIN:VEVENT",`UID:chorbit-${e.id}-${o}@chorechart.app`,`DTSTART:${a.toISOString().replace(/[-:]/g,"").split(".")[0]}Z`,`DTEND:${n.toISOString().replace(/[-:]/g,"").split(".")[0]}Z`,`SUMMARY:${s.name}`,`DESCRIPTION:Generated by Chorbit AI\\n${s.tips||"You've got this!"}`,"STATUS:CONFIRMED","END:VEVENT")}),r.push("END:VCALENDAR"),r.join("\r\n")}clearHistory(){this.conversationHistory=[]}getHistory(){return[...this.conversationHistory]}constructor(){this.conversationHistory=[]}}let n=new a},10846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},29294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},44870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},63033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},78335:()=>{},96487:()=>{}};var t=require("../../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),s=t.X(0,[243,580,312],()=>r(4291));module.exports=s})();